...
const RegistrationForm: React.FC<RegistrationFormProps> = ({ onRegister, onSwitchToLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-paygo-lavender flex flex-col items-center justify-center p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <Input
              ...
              className="w-full h-14 text-lg border-0 glass-input rounded-xl shadow-sm placeholder:text-muted-foreground"
              required
            />
          </div>
          ...
          <div>
            <Select value={country} onValueChange={setCountry} required>
              <SelectTrigger className="w-full h-14 text-lg border-0 glass-input rounded-xl shadow-sm">
          ...
          <Button
            type="submit"
            className="w-full h-14 gradient-purple hover:opacity-90 text-white text-lg font-medium rounded-xl transition-all"
          >
            Register
          </Button>
        </form>
