...
import { Loader2, Lock, Mail, Eye, EyeOff, Shield, ArrowLeft, LogOut } from 'lucide-react';
...
const AdminPanel = () => {
  ...
  if (showAdminPanel && isAdmin) {
    return (
      <PaymentUploadsAdmin onBack={() => setShowAdminPanel(false)} />
    );
  }
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-bold text-foreground">Payment Uploads</h3>
              <p className="text-muted-foreground text-sm">Review and approve payment screenshots</p>
            </div>
